...
use App\Http\Controllers\PromptStudioController;
...
Route::get('/prompt-studio', [PromptStudioController::class, 'index'])->name('prompt-studio.index');
Route::post('/prompt-studio/templates', [PromptTemplateController::class, 'store'])->name('prompt-studio.templates.store');
Route::put('/prompt-studio/templates/{promptTemplate}', [PromptTemplateController::class, 'update'])->name('prompt-studio.templates.update');
Route::delete('/prompt-studio/templates/{promptTemplate}', [PromptTemplateController::class, 'destroy'])->name('prompt-studio.templates.destroy');
Route::post('/prompt-studio/compose', [PromptTemplateController::class, 'compose'])->name('prompt-studio.compose');
