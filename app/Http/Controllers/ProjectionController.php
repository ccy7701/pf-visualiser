...
class ProjectionController extends Controller
{
    ...
    private function projectionRules(): array
    {
        return [
            ...
            'cost_of_living.budgets.*' => ['required', 'array'],
            'cost_of_living.budgets.*.name' => ['nullable', 'string', 'max:120'],
            ...
            'cost_of_living.monthly_budget_selection.*.budget' => ['required_with:cost_of_living.monthly_budget_selection', 'string', 'max:120'],
